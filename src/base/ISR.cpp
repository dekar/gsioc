...
__attribute__((section(".isr_vector"))) const ISR::ShortISRVector interruptsVectorTable =
#else
__attribute__((section(".isr_vector"))) const ISR::ISRVector interruptsVectorTable =
#endif
{
#ifdef USE_MEMORY_ISR
    _estack,
...
__attribute__((section(".isr_vector2"))) ISR::ISRVector MeminterruptsVectorTable =
{
#endif
    _estack,
    ISR::Reset,
...
#pragma weak SysTickI			     = DefaultHandler
